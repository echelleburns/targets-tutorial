...
▶ dispatched target sample_sizes</br>
● completed target sample_sizes [0.292 seconds, 56 bytes]</br>
▶ dispatched target known_sd</br>
● completed target known_sd [0 seconds, 50 bytes]</br>
▶ dispatched target known_mean</br>
● completed target known_mean [0 seconds, 51 bytes]</br>
▶ dispatched target random_all</br>
● completed target random_all [0.009 seconds, 7.756 kilobytes]</br>
▶ dispatched target combined_data_summaries</br>
● completed target combined_data_summaries [0.004 seconds, 229 bytes]</br>
▶ dispatched target percent_differences</br>
● completed target percent_differences [0.001 seconds, 292 bytes]</br>
▶ dispatched target comparison_figure</br>
● completed target comparison_figure [0.03 seconds, 214.703 kilobytes]</br>
▶ ended pipeline [0.454 seconds]</br>
</span>
...
```{r}
#| eval: false
# To load individual variables
targets::tar_load(c("known_mean")) 
